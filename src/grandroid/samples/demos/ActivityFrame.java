...
import grandroid.samples.demos.activity.DialogDemo;
import grandroid.samples.demos.activity.SideMenuDemo;
import grandroid.view.LayoutMaker;
import java.util.ArrayList;

public class ActivityFrame extends SampleFace {

    ObjectAdapter<String> adapter;
    protected String[] list = {"Dialog",  "Sidemenu"};
            ...
            adapter = new ObjectAdapter<String>(this, array) {
                ...
                public void onClickItem(int index, View view, String item) {
                    switch (index) {
                        ...
                        case 0:
                            new GoAction(ActivityFrame.this, DialogDemo.class, 1).execute();
                            break;
//                        case 1:
//                            new GoAction(ActivityFrame.this, FragmentDemo.class, 1).execute();
//                            break;
                        case 1:
                            new GoAction(ActivityFrame.this, SideMenuDemo.class, 1).execute();
                            break;
                    }
                }
