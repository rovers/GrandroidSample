...
import grandroid.samples.demos.database.DataAgentDemo;
import grandroid.samples.demos.database.FaceDataDemo;
import grandroid.samples.demos.database.GenericHelperDemo;
import grandroid.view.LayoutMaker;
import java.util.ArrayList;

public class DataBaseFrame extends SampleFace {

    ObjectAdapter<String> adapter;
    protected String[] list = { "FaceData", "GenericHelper", "DataAgent"};
        ...
        maker.addColLayout(false, maker.layFW());
        {
            ...
            adapter = new ObjectAdapter<String>(this, array) {
                ...
                public void onClickItem(int index, View view, String item) {
                    switch (index) {
//                        case 0:
//                            new GoAction(DataBaseFrame.this, IdentifiableDemo.class, 1).execute();
//                            break;
                        case 0:
                            new GoAction(DataBaseFrame.this, FaceDataDemo.class, 1).execute();
                            break;
                        case 1:
                            new GoAction(DataBaseFrame.this, GenericHelperDemo.class, 1).execute();
                            break;
                        case 2:
                            new GoAction(DataBaseFrame.this, DataAgentDemo.class, 1).execute();
                            break;
