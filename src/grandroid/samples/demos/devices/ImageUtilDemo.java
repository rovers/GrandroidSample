...
public class ImageUtilDemo extends SampleFace {

    ObjectAdapter<String> adapter;
    protected String[] list = {"Loader", "Download", "Save"};
        ...
        maker.addColLayout(false, maker.layFF());
        {
            ...
            adapter = new ObjectAdapter<String>(this, array) {
                ...
                public void onClickItem(int index, View view, String item) {
                    switch (index) {
                        case 0:
                            new GoAction(ImageUtilDemo.this, ImageUtilLoaderDemo.class, 1).execute();
                            break;
                        case 1:
                            new GoAction(ImageUtilDemo.this, ImageUtilDownloadDemo.class, 1).execute();
                            break;
                        case 2:
                            new GoAction(ImageUtilDemo.this, ImageUtilSaveDemo.class, 1).execute();
                            break;
